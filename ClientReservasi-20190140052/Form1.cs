...
namespace ClientReservasi_20190140052
{
    public partial class Form1 : Form
    {
        ...
        {
            textBoxID.Text = Convert.ToString(form2.Rows[e.RowIndex].Cells[0].Value);
            textBoxNama.Text = Convert.ToString(form2.Rows[e.RowIndex].Cells[3].Value);
            textBoxNoTlf.Text = Convert.ToString(form2.Rows[e.RowIndex].Cells[4].Value);
            textBoxJumlah.Text = Convert.ToString(form2.Rows[e.RowIndex].Cells[1].Value);
            textBoxIDLokasi.Text = Convert.ToString(form2.Rows[e.RowIndex].Cells[2].Value);
